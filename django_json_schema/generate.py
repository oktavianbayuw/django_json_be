...
def insert_json(request):
    if request.method == 'POST':
        ...
        if existing_instance:
            ...
            existing_instance.save()  # Save changes
            ...
            if serializer.is_valid():
                ...
                return Response({'status': 400, 'message': 'Data Gagal Ditambahkan', 'errors': serializer.errors})

    return Response({'message': 'Metode HTTP tidak didukung', 'status': 405}, status=405)
